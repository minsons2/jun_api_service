/*工具类*/
var JUNUtil = (function () {
    var junUtil = {};

    /*GET*/
    junUtil.sendGet = function(url, params, ft){
        this.sendAJAX(url, params, ft, "GET")
    }

    /*POST*/
    junUtil.sendPost = function(url, params, ft){
        this.sendAJAX(url, JSON.stringify(params), ft, "POST")
    }
    /*PUT*/
    junUtil.sendPut = function(url, params, ft){
        this.sendAJAX(url, JSON.stringify(params), ft, "PUT")
    }
    /*DELETE*/
    junUtil.sendDelete = function(url, params, ft){
        this.sendAJAX(url, JSON.stringify(params), ft, "DELETE")
    }


    /*ajax*/
    junUtil.sendAJAX = function(url, params, ft, method){
        ...
        $.ajax({
            ...
            beforeSend: function(request) {
                request.setRequestHeader("authorization", JUNUtil.getData("access_token"));
            },
    ...
    /*存入本地缓存*/
    junUtil.setData = function(key, value){
    ...
    /*从本地缓存拿数据*/
    junUtil.getData = function(key){
        var localData = layui.data('LocalData');
        return localData[key];
    };

    //判断字符是否为空的方法
    junUtil.isEmpty = function(obj){
    ...
    //字典数据回显
    junUtil.selectDictLabel = function (datas, value) {
