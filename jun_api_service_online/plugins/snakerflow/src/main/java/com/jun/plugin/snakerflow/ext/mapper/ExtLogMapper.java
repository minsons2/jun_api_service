package com.jun.plugin.snakerflow.ext.mapper;

import java.util.List;

import com.jun.plugin.snakerflow.ext.entity.ExtLog;
import com.jun.plugin.snakerflow.ext.vo.LogStatisticsTop10Vo;
import com.jun.plugin.snakerflow.ext.vo.LogStatisticsVo;
