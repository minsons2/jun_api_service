package com.jun.plugin.sms.service;
...
public class SendSmsImpl implements SendSms{
    ...
    public boolean send(String phoneNum, String templateCode, String[] param) {
        ...
        try {
            ...
            Credential cred = new Credential("AKIDb4KMAkBTZTAbmiQu98sOjpgHfokS2XzO", "NfpspgP1YzJYghbP6hAXnx1yrgJkxvd5");
            ...
            String sdkAppId = "1400595817";
            req.setSmsSdkAppId(sdkAppId);

            /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名 */
            // 签名信息可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-sign) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-sign) 的签名管理查看
            String signName = "新博技术";
