package com.jun.plugin.aoplog.aspect;

import com.alibaba.fastjson.JSON;
import com.jun.plugin.aoplog.annotation.LogAnnotation;
import com.jun.plugin.aoplog.entity.SysLog;
import com.jun.plugin.aoplog.mapper.SysLogMapper;
...
//    private HttpSessionService httpSessionService;
     ...
     */
    @Pointcut("@annotation(com.jun.plugin.aoplog.annotation.LogAnnotation)")
    ...
    private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        //用户名
        String userId = "admin";//httpSessionService.getCurrentUserId();
        String username = "admin";//httpSessionService.getCurrentUsername();
