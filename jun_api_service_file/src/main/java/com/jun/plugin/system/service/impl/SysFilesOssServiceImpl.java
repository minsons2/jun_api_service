...
import com.jun.plugin.module.qiniu.QiniuUtils;
...
import com.jun.plugin.system.mapper.SysFilesOssMapper;
...
public class SysFilesOssServiceImpl extends ServiceImpl<SysFilesOssMapper, SysFilesOssEntity> implements SysFilesOssService {
    @Resource
...
//		sysFilesOssMapper.insert(entity);
    ...
    public void removeByIdsAndFiles(List<String> ids) {
        List<SysFilesOssEntity> list = this.listByIds(ids);
        list.forEach(entity -> {
