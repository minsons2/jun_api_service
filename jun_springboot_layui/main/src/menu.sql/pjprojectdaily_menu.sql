...
INSERT INTO sys_permission (id,pid, name, url, perms,  type, deleted, status,create_time,update_time)
	...
	INSERT INTO sys_permission (id,pid, name, url, perms,  type, deleted, status,create_time,update_time)
    VALUES ('145074079284106035611', '1450740792841060353', '复制' , 'pjProjectDaily/copy','pjProjectDaily:copy', '3',1, 1,now(),now());
	
	INSERT INTO sys_permission (id,pid, name, url, perms,  type, deleted, status,create_time,update_time)
    VALUES ('145074079284106035622', '1450740792841060353', '提交' , 'pjProjectDaily/submit','pjProjectDaily:submit', '3',1, 1,now(),now());
