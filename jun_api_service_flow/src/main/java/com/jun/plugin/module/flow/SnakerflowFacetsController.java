...
import com.jun.plugin.module.flow.process.SnakerHelper;
...
//	private BizCommonService bizCommonService;
	...
	public PageResponse userTaskTodoList(String username) {
		log.info("sessionService.getCurrentUsername()=" + sessionService.getCurrentUsername());
...
//                	sysUserService.getById(sessionService.getCurrentUsername());
					// SysUser sysUser = sysUserService.getById(String.valueOf(actor));
					SysUser sysUser = sysuer.getUserByName(actor);
					String nickName = sysUser == null || sysUser.getRealName() == null ? "NONE" : sysUser.getNickName();
