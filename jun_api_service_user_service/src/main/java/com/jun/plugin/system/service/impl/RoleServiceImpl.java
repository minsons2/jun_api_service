...
import com.jun.plugin.system.mapper.SysRoleMapper;
...
public class RoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements RoleService {
    ...
    @Override
//    @Cacheable(cacheNames = "cache1m",key = "'RoleServiceImpl:getRoleInfoByUserId:'+#userId")
    public List<SysRole> getRoleInfoByUserId(String userId) {
    	System.err.println("getRoleInfoByUserId="+userId);
