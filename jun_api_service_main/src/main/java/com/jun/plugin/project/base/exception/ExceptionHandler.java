package com.jun.plugin.project.base.exception;
...
public class ExceptionHandler {
    ...
    public Result handleQueryTimeoutException(Exception e) {
    	log.error("Exception,exception:{}", e, e);
    	return Result.getResult(BizResponseCode.SYSTEM_REDIS_BUSY);
    }
...
//    }
    ...
    Result methodArgumentNotValidExceptionHandler(MethodArgumentNotValidException e) {
        ...
        return Result.getResult(BizResponseCode.METHODARGUMENTNOTVALIDEXCEPTION.getCode(), errors.get(0).getDefaultMessage());
    }
    ...
    public Result handle(ConstraintViolationException exception) {
        ...
        return Result.getResult(BizResponseCode.METHODARGUMENTNOTVALIDEXCEPTION.getCode(), builder.toString());
    }
